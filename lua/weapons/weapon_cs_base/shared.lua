...
-- SWEP.Primary. DefaultClip -- OBSOLEET!	= -1
...
-- use game.SinglePlayer()
function singleplayer(self)
...
function SWEP:PrimaryAttack()
	...
	self.Owner:ViewPunch( Angle( math.Rand(-0.2,-0.1) * self.Primary.Recoil,
...
function SWEP:CSShootBullet( dmg, recoil, numbul, cone )
	...
	bullet.Force	= dmg/2									// Amount of force to give to phys objects
	bullet.Damage	= dmg

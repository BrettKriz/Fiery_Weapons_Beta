...
SWEP.PrintName				= "Fists (WIP)"
SWEP.Category				= "Fiery Dev"

SWEP.Author					= "robotboy655 & MaxOfS2D, Tenrys, Nova Prospekt"
SWEP.Purpose				= "Well we sure as hell didn't use guns!\n We would just wrestle Hunters to the ground with our bare hands!\n I used to kill ten, twenty a day, just using my fists."

SWEP.Spawnable				= true
SWEP.UseHands				= true
SWEP.DrawAmmo				= false

SWEP.ViewModel				= "models/weapons/cstrike/c_arms_citizen.mdl"
SWEP.WorldModel				= "" -- Exactly, nothing
